...
if ( ! function_exists( 'envato_theme_setup_wizard' ) ) :
	function envato_theme_setup_wizard() {
				...
				public function theme_setup_wizard_content($content){
					if($this->is_possible_upgrade()){
						array_unshift_assoc($content,'upgrade',array(
							'title' => esc_html__( 'Upgrade', 'somo' ),
							'description' => esc_html__( 'Upgrade Content and Settings', 'somo' ),
							'pending' => esc_html__( 'Pending.', 'somo' ),
							'installing' => esc_html__( 'Installing Updates.', 'somo' ),
        ...
        public function envato_theme_verification() {
          ?>
          <h1><?php echo esc_html__('Verification', 'somo') ?></h1>
